...
Hit `ctrl+c` in your terminal/command prompt to turn off the preview.
...
If you want to modify the theme used to generate your site, you can open the `pelicanconf.py` file in your website folder, and change the line that looks like this:
