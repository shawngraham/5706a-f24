---
title: "Webmapping with Leaflet"
description: "Building a webmap using leaflet.js"
lead: "Building a webmap using leaflet.js can be tricky."
...
9. The terminal will tell you now that your server is running at an address that will look something like this: `http://0.0.0.0:8000/` _or_ `http://localhost:8000`. Copy that full address and paste it into your browser's address bar.
...
<img src="https://i.imgur.com/bmNCzg6.png" width="600" />
...
<img src="https://i.imgur.com/yULDRQR.jpg" width="600" />
