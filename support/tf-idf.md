...
1. Right-click, save-as, [this zip file with some text files](/data/data-for-tf-idf.zip). These are the original text files for the 'syllabus' part of this course website, by the way.
