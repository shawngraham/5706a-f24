...
{{< alert theme="info" >}}
For our purposes, you will use Github mostly as a place to put things you make, your logs and ancillary work.
{{< /alert >}}
...
10. **Private Repo**: Then find my username `shawngraham` (my avatar is a minion; here's my [github.com account](https://github.com/shawngraham)), and add me:
...
{{< alert theme="info" >}}
To create new repositories, just click on the `+` button on the top right of your Github page when you're logged in. Most of the time, you will want to remember to tick off the `initialize with a readme` box.
{{< /alert >}}
